...
@Component({
  ...
  selector: 'app-root',
  template: `
    <div class="w-full  dark:bg-gradient-to-r dark:from-slate-700 dark:to-slate-800 h-screen bg-[rgb(253,245,241)] ">
      <div class="w-full   flex md:flex-row flex-col mx-0 md:mx-auto md:p-10  text-[rgb(128,131,141)] md:max-w-7xl mt-auto h-screen">
        <div class="flex rounded-tl-md rounded-bl-md flex-col dark:bg-slate-600 justify-between w-[100%] md:w-[30%] drop-shadow-xl   p-10 pr-10 bg-[rgb(240,240,240)]">
        ...
        <div class="overflow-y-scroll dark:bg-slate-700 dark:text-white  pb-12 flex  w-full flex-col md:w-[70%] relative rounded-tr-md rounded-br-md drop-shadow-md bg-white">
          <nav class="sticky flex flex-row items-center justify-between px-5 top-0 left-0 w-full h-[50px]  pt-2 pb-2 bg-white dark:dark:bg-slate-800 drop-shadow-md">
            <ul class="h-full flex gap-6  items-center">
              <a  class="hover:scale-125 transition-all text-sm cursor-pointer">Home</a>
            </ul>
